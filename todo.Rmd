...
- think about unified data model for all 3 scrapers...
- or better maybe to keep them separate?
- change window of pulled data and increase number of pulled events
- change db dir to somewhere outside of pkg dir
- investigate other bars and venues around Rembrandtplein
- write docs
